@extends('superadmin.partials.dashboard2')
@section('container')
      ...
      <div class="row layout-top-spacing">
              ...
              <div class="w-numeric-value">
                <div class="w-content">
                  ...
                  <span class="w-numeric-title"
                    >Go to columns for details.</span
                  >
                </div>
                <div class="w-icon">
                  <svg
        ...
        >
          <div class="widget widget-wallet-one">
            <div class="wallet-info text-center mb-3">
              ...
              <a href="#" class="wallet-text"
                ><svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  class="feather feather-trending-up me-2"
                >
                  <polyline
            ...
            <div
              class="wallet-action text-center d-flex justify-content-around"
            >
              ...
              <li class="list-group-item">
                <div class="media">
                  <div class="me-3">
                    <img
                      alt="avatar"
                      src="../src/assets/img/netflix.svg"
              ...
              <li class="list-group-item">
                <div class="media">
                  <div class="me-3">
                    <img
                      alt="avatar"
                      src="../src/assets/img/apple-app-store.svg"
                      class="img-fluid rounded-circle"
                    />
                  </div>
                  <div class="media-body">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="td-content product-name">
                          <img
                            src="../src/assets/img/product-headphones.jpg"
                            alt="product"
                          />
                    ...
                    <tr>
                      <td>
                        <div class="td-content product-name">
                          <img
                            src="../src/assets/img/product-shoes.jpg"
                            alt="product"
                          />
                          <div class="align-self-center">
                            <p class="prd-name">Shoes</p>
                            <p class="prd-category text-warning">
                              Faishon
                            </p>
                          </div>
                        </div>
                    ...
                    <tr>
                      <td>
                        <div class="td-content product-name">
                          <img
                            src="../src/assets/img/product-watch.jpg"
                            alt="product"
                          />
                          <div class="align-self-center">
                    ...
                    <tr>
                      <td>
                        <div class="td-content product-name">
                          <img
                            src="../src/assets/img/product-laptop.jpg"
                            alt="product"
                          />
                          <div class="align-self-center">
                    ...
                    <tr>
                      <td>
                        <div class="td-content product-name">
                          <img
                            src="../src/assets/img/product-camera.jpg"
                            alt="product"
                          />
                          <div class="align-self-center">
