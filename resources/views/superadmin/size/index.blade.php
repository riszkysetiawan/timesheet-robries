        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    ...
                    <a href="{{ route('size-produk.admin.create') }}" class="btn btn-primary">Tambah Data</a>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
            ...
            <div class="row layout-top-spacing">
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    ...
                    <button class="btn btn-outline-success btn-rounded mb-2 me-4"
                        onclick="window.location.href='{{ route('size.download.excel.admin') }}'">
    ...
    <script>
        $(document).ready(function() {
            $('#zero-config').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('size-produk.admin.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
        ...
        function deleteUser(kategoriId) {
            $.ajax({
                url: '/delete/size/produk/admin/' + kategoriId,
                method: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
