        ...
        $(document).ready(function() {
            ...
            $(document).on('change', 'select[name="kode_barang[]"]', function() {
                ...
                if (kode_barang) {
                    ...
                    $.ajax({
                        url: '/get-barang/' + kode_barang, // Ganti URL dengan route yang sesuai
                        type: 'GET',
                        dataType: 'json',
            ...
            function calculateTotalRow(row) {
                ...
                var harga = parseCurrency(row.find('input[name="harga[]"]')
                    .val()); // Menggunakan parseCurrency untuk membersihkan input harga
                var subTotal = harga * qty;

                // Update subtotal di dalam baris
                row.find('.amount').text(formatRupiah(subTotal));
                row.find('input[name="sub_total[]"]').val(subTotal); // Set nilai asli untuk field sub_total
            }
