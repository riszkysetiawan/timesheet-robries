                                                                ...
                                                                <div class="text-sm-end">
                                                                    <div class="row">
                                                                        <div class="col-sm-8 col-7 mt-3">
                                                                            <h3 class=""> Total : Rp</h3>
                                                                            <h3 class=""> Jumlah Bayar : Rp</h3>
                                                                            <h3 class=""> Kembali : Rp</h3>
                                                                        </div>
                                                                        <div class="col-sm-4 col-5  mt-3">
                                                                            <h4 class="">
                                                                                {{ number_format($penjualans->total) }}
                                                                            </h4>
                                                                            <h4 class="">
                                                                                {{ number_format($penjualans->jumlah_bayar) }}
                                                                            </h4>
                                                                            <h4 class="">
                                                                                {{ number_format($penjualans->kembali) }}
                                                                            </h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="invoice-action-btn">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-3 col-sm-6">
                                                <a href="{{ route('penjualan.cetak.nota.admin', Crypt::encryptString($penjualans->kode_invoice)) }}"
                                                    class="btn btn-secondary btn-print ">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
                                                        <path
                                                            d="M2 5a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h1v3h10v-3h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H2zm3-3h6a2 2 0 0 1 2 2v1H3V4a2 2 0 0 1 2-2zm7 12H4v-4h8v4z" />
                                                    </svg>
                                                    Print
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-md-3 col-sm-6">
                                                <a href="{{ route('penjualan.admin.edit', Crypt::encryptString($penjualans->kode_invoice)) }}"
    ...
    <script>
        $(document).ready(function() {
            $('#btn_download_pdf').on('click', function() {
                // Get the encrypted invoice ID (you might need to pass it from the view)
                var invoiceId = "{{ Crypt::encryptString($penjualans->kode_invoice) }}";

                // Perform AJAX request to generate the PDF
                $.ajax({
                    url: '/penjualan/pdf/' + invoiceId, // Adjust URL if necessary
                    type: 'POST',
                    data: {
