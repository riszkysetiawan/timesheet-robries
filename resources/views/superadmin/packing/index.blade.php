        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <a href="{{ route('packing.admin.create') }}" class="btn btn-outline-primary btn-rounded mb-2 me-4">
                            ...
                            <table id="zero-config" class="table table-striped dt-table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>SO Number</th>
                                        <th>Vendor Pengiriman</th>
                                        <th>Nama Operator</th>
                                        <th>Foto Sebelum Packing</th>
                                        <th>Foto Setelah Packing</th>
