...
@section('title', ' Tambah Vendor Pengiriman')
@section('container')
    <div class="container">
        <div class="container">
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Tambah Vendor Pengiriman</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form id="satuan">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label for="warna" class="form-label">Nama</label>
    ...
    <script>
        $(document).ready(function() {
            $('#satuan').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('vendor-pengiriman.admin.store') }}",
                    method: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
