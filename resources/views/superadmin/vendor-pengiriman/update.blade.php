...
@section('title', 'Update Vendor Pengiriman')
@section('container')
    <div class="container">
        <div class="container">
            <div class="row">
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="satuanForm">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                            name="nama" id="nama" value="{{ old('nama', $vendor->nama) }}"
                                            required />
                                    </div>
                                </div>
                                ...
                                <button type="button" class="btn btn-outline-dark btn-rounded mb-2 me-4"
                                    onclick="window.location.href='{{ route('role.admin.index') }}'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <script>
        $('#satuanForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('vendor-pengiriman.admin.update', Crypt::encryptString($vendor->id)) }}",
                method: 'POST',
                data: formData,
                        ...
                        Swal.fire(
                            ...
                            if (result.isConfirmed) {
                                window.location.href =
                                    '{{ route('vendor-pengiriman.admin.index') }}';
                            }
                        });
                    }
                },
