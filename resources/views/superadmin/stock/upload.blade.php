            ...
            <div id="fuMultipleFile" class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <button type="button" class="btn btn-outline-success btn-rounded mb-2 me-4"
                            onclick="window.location.href='{{ route('download.template.upload.stock.admin') }}'">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#upload-excel-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('upload.stock.excel.admin') }}",
                    data: formData,
                    contentType: false,
                    processData: false,
