                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <div class="table-responsive">
                            <table id="stock-barang-table" class="table table-striped dt-table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Kode Produk</th>
                    ...
                    <button class="btn btn-outline-primary btn-rounded mb-2 me-4"
                        onclick="window.location.href='{{ route('stock.download.excel.admin') }}'">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        Swal.fire('Dihapus!', 'Stock Barang berhasil dihapus.', 'success')
                            .then(() => location.reload());
                    } else {
                        Swal.fire('Gagal!', 'Terjadi kesalahan saat menghapus Stock Barang.', 'error');
                    }
                },
                error: function() {
                    Swal.fire('Gagal!', 'Terjadi kesalahan saat menghapus Stock Barang.', 'error');
