...
@section('title', 'Update Proses Produksi')
@section('container')
    <div class="container">
        <div class="container">
            <div class="row">
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="editData">
                                ...
                                <button type="button" class="btn btn-outline-dark btn-rounded mb-2 me-4"
                                    onclick="window.location.href='{{ route('proses.admin.index') }}'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <script>
        $('#editData').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('proses.admin.update', Crypt::encryptString($kategori->id)) }}",
                method: 'POST',
                data: formData,
