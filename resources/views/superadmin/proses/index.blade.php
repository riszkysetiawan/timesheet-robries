...
@section('title', 'List Proses Produksi')
@section('container')
        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    ...
                    <a href="{{ route('proses.admin.create') }}" class="btn btn-primary">Tambah Data</a>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
            ...
            <div class="row layout-top-spacing">
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    ...
                    {{-- <button class="btn btn-outline-success btn-rounded mb-2 me-4"
                        onclick="window.location.href='{{ route('proses.download.excel.admin') }}'">
    ...
    <script>
        ...
        function deleteUser(kategoriId) {
            $.ajax({
                url: '/delete/proses/admin/' + kategoriId,
                method: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
