...
@section('container')
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                            name="nama" id="nama" value="{{ old('nama', $role->nama) }}" required />
                                        @error('warna')
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                                            ...
                                            value="{{ old('keterangan', $role->keterangan) }}" />
                                        @error('keterangan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
    ...
    <script>
        $('#satuanForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('role.admin.update', Crypt::encryptString($role->id)) }}",
                method: 'POST',
                data: formData,
