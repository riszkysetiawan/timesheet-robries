...
@section('container')
        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <a href="{{ route('produk.admin.create') }}" class="btn btn-outline-primary btn-rounded mb-2 me-4">
            ...
            <div class="row layout-top-spacing">
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    ...
                    <button class="btn btn-outline-success btn-rounded mb-2 me-4"
                        onclick="window.location.href='{{ route('produk.download.excel.admin') }}'">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
    ...
    <script>
        ...
        function deleteUser(kode_produk) {
            $.ajax({
                url: '/delete/produk/admin/' + kode_produk,
                method: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
