...
@section('container')
                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="satuanForm">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label for="warna" class="form-label">Oven</label>
                                        <input type="text" class="form-control" name="nama" id="nama"
                                            value="{{ old('nama', $oven->nama) }}" required />
                                    </div>
                                </div>
                                ...
                                <button type="button" class="btn btn-outline-dark btn-rounded mb-2 me-4"
                                    onclick="window.location.href='{{ route('oven.admin.index') }}'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <script>
        $('#satuanForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('oven.admin.update', Crypt::encryptString($oven->id)) }}",
                method: 'POST',
                data: formData,
