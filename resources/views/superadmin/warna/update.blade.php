...
@section('title', 'Update Satuan Barang')
@section('container')
    <div class="container">
        <div class="container">
            <div class="row">
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="satuanForm">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control @error('warna') is-invalid @enderror"
                                            name="warna" id="warna" value="{{ old('warna', $warna->warna) }}"
                                            required />
                                        @error('warna')
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                                            ...
                                            value="{{ old('keterangan', $warna->keterangan) }}" />
                                        @error('keterangan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <button type="button" class="btn btn-outline-dark btn-rounded mb-2 me-4"
                                    onclick="window.location.href='{{ route('warna.admin.index') }}'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <script>
        $('#satuanForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('warna.admin.update', Crypt::encryptString($warna->id)) }}",
                method: 'POST',
                data: formData,
