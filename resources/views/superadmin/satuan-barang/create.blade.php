                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="satuan">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label for="" class="form-label">Satiuan Barang</label>
                                ...
                                <button type="button" class="btn btn-outline-dark btn-rounded mb-2 me-4"
                                    onclick="window.location.href='{{ route('satuan-barang.admin.index') }}'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <script>
        $(document).ready(function() {
            $('#satuan').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('satuan-barang.admin.store') }}",
                    method: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    window.location.href =
                                        '{{ route('satuan-barang.admin.index') }}';
                                }
                            });
                        }
                    },
