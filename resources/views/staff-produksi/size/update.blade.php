...
@section('title', 'Update Size Produk')
@section('container')
    <div class="container">
        <div class="container">
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="editData">
                                ...
                                <button type="button" class="btn btn-outline-dark btn-rounded mb-2 me-4"
                                    onclick="window.location.href='{{ route('size-produk.production-staff.index') }}'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <script>
        $('#editData').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('size-produk.production-staff.update', Crypt::encryptString($size->id)) }}",
                method: 'POST',
                data: formData,
                        ...
                        Swal.fire(
                            ...
                            if (result.isConfirmed) {
                                window.location.href =
                                    '{{ route('size-produk.production-staff.index') }}';
                            }
                        });
                    }
                },
