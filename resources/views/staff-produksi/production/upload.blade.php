@extends('staff-produksi.partials.upload')
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-rounded mb-2 me-4"
                            onclick="window.location.href='{{ route('download.template.upload.production.production-staff') }}'">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#upload-excel-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('upload.production.excel.production-staff') }}",
                    data: formData,
                    contentType: false,
                    processData: false,
