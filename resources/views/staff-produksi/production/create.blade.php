@extends('staff-produksi.partials.penjualan')
@section('title', 'Tambah Item Production')
@section('container')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kode_produk_select').on('change', function() {
                ...
                if (kode_produk) {
                    $.ajax({
                        url: '/get-produk/production-staff/' + kode_produk,
                        type: 'GET',
                        dataType: 'json',
            ...
            $('#size_select').on('change', function() {
                ...
                if (kode_produk) {
                    $.ajax({
                        url: '/get-ukuran/production-staff/' + kode_produk,
                        type: 'GET',
                        dataType: 'json',
                        success: function(data) {
                            if (data) {
