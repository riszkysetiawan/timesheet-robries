@extends('staff-produksi.partials.datatablescustomer')
...
@section('container')
        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <a href="{{ route('production.production-staff.create') }}" class="btn btn-primary">
            ...
            <div class="row layout-top-spacing">
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    ...
                    <button class="btn btn-outline-secondary btn-rounded mb-2 me-4"
                        onclick="window.location.href='{{ route('upload.production.files.production-staff') }}'">
                        Upload File</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#scanButton').on('click', function() {
                ...
                const qrCodeSuccessCallback = (decodedText, decodedResult) => {
                    ...
                    $.ajax({
                        url: `/production/production-staff/timerbarcode/${encodedBarcode}`,
                        method: 'GET',
        ...
        $('#downloadExcel').on('click', function() {
            ...
            let url = "{{ route('production.download.excel.production-staff') }}";
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#penjualan-table').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ route('production.production-staff.index') }}",
    ...
    <script>
        ...
        function deleteProduction(id) {
            $.ajax({
                url: '/delete/production/production-staff/' + id,
                method: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
