...
<head>
    ...
    <link href="{{ asset('cork/html/layouts/vertical-light-menu/css/light/plugins.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('cork/html/src/assets/css/light/pages/error/error.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('cork/html/layouts/vertical-light-menu/css/dark/plugins.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('cork/html/src/assets/css/dark/pages/error/error.css') }}" rel="stylesheet" type="text/css" />
...
<body class="error text-center">
        ...
        <div class="row">
            {{-- <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
                <a href="index.html" class="ml-md-5">
                    <img alt="image-404" src="{{ asset('toko jali.jpg') }}" class="dark-element theme-logo">
                    <img alt="image-404" src="{{ asset('toko jali.jpg') }}" class="light-element theme-logo">
                </a>
            </div> --}}
        </div>
    </div>
    <div class="container-fluid error-content">
        <div class="">
            ...
            <p class="mini-text">UPPSSSS!</p>
            <p class="error-text mb-5 mt-1">Tidak Ada Halaman Yang Tersedia</p>
            <img src="{{ asset('logo.jpg') }}" alt="cork-admin-404" class="error-img">
