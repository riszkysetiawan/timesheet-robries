...
class ProdukStaffProduksiController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('staff-produksi.produk.index');
    }
    ...
    public function downloadBarcode($encryptedKodeproduk)
    {
        ...
        $pdf = PDF::loadView('staff-produksi.barcode.pdf_gambar', compact('produk', 'barcodeImage'))
    ...
    {
        return view('staff-produksi.produk.upload');
    }
    ...
    public function downloadLaporan($id)
    {
        ...
        $pdf = PDF::loadView('staff-produksi.laporan.produk_pdf', ['produks' => $produks]);
    ...
    //     return view('staff-produksi.laporan.produk');
    // }
    ...
    public function downloadPdf()
    {
        ...
        $pdf = PDF::loadView('staff-produksi.produk.pdf', ['produks' => $produks])
    ...
    public function create()
    {
        ...
        return view('staff-produksi.produk.create', compact('kategoris', 'warnas', 'sizes'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff-produksi.produk.update', compact('produk', 'kategoris', 'warnas', 'sizes'));
    }
