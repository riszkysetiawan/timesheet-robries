...
class SizeStaffProduksiController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('staff-produksi.size.index');
    }
    /**
    ...
    {
        return view('staff-produksi.size.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff-produksi.size.update', compact('size'));
    }
