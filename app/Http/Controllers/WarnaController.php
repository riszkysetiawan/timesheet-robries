...
class WarnaController extends Controller
{
    ...
    //     return view('superadmin.warna.index', compact('satuans'));
    // }
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($satuans)
                ...
                ->addColumn('action', function ($satuan) {
                    $editUrl = route('warna.admin.edit', Crypt::encryptString($satuan->id));
                    return '
        ...
        return view('superadmin.warna.index');
    }
    /**
    ...
    {
        return view('superadmin.warna.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin.warna.update', compact('warna'));
    }
